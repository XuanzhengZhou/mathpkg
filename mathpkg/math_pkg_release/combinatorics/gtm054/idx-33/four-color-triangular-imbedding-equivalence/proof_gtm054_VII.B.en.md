...
role: proof
locale: en
of_concept: four-color-triangular-imbedding-equivalence
source_book: gtm054
source_chapter: "VII"
source_section: "B"
---
...
We define
$$Z_{i,j} = \{E_{i,j+1}, \{x_{i,j+1}, y_i\}, \ldots\}$$
for each region. It is then straightforward to verify that the collection
$$\{Z_{i,j} : j = 0, \ldots, q_i - 1; i = 1, \ldots, m\}$$
is a triangular imbedding of $\Theta$.

Once again, the converse is obvious. $\square$
