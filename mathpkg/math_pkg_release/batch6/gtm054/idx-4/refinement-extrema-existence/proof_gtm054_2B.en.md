...
role: proof
locale: en
of_concept: refinement-extrema-existence
source_book: gtm054
source_chapter: "II"
source_section: "B"
---
...
To complete the proof, we define a relation $\sim$ on $U$ whereby $x \sim y$ if and only if for all $S \in \mathcal{S}$, $x \in S \Leftrightarrow y \in S$. The equivalence classes of $\sim$ form a partition that is the maximum element of $\{ \mathcal{Q} \in \mathbb{P}(U) : \mathcal{Q} \leq \mathcal{S} \}$.
