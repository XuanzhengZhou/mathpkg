Let $(x, X)$ be an instantaneous observer, $\chi \in M_x^*$ be physically equivalent to $X$, $\pi_X: P_X \to \mathcal{L}_x^+$, and $\Lambda_x$ be the natural volume element on $\mathcal{L}_x^+$.
