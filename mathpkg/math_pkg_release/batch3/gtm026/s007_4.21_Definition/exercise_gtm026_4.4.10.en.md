...
This exercise should help the reader to appreciate why isomorphic algebras are "abstractly the same."
...
(c) (Cf. 2.3.1 below.) If $(Y, \gamma)$ is an $(\Omega, E)$-algebra and if $f: X \longrightarrow Y$ is a bijection, prove that there exists a unique $\delta$ such that $f: (X, \delta) \longrightarrow (Y, \gamma)$ is an $\Omega$-homomorphism and then that $(X, \delta)$ is an $(\Omega, E)$-algebra and that $f$ is an isomorphism.
