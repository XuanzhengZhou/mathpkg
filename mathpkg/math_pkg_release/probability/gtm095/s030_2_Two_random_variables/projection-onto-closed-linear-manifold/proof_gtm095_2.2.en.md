...
role: proof
locale: en
of_concept: projection-onto-closed-linear-manifold
source_book: gtm095
source_chapter: "2"
source_section: "2"
---

# Proof of Projection onto a Closed Linear Manifold
...
It remains to verify that $\hat{\xi}$ has the form (21). Set $\hat{\xi}_n = \sum_{i=1}^{n} (\xi, \eta_i) \eta_i$. Then by (5),

$$\|\xi - \hat{\xi}_n\|^2 = \|\xi\|^2 - \sum_{i=1}^{n} |(\xi, \eta_i)|^2 \to \|\xi\|^2 - \sum_{i=1}^{\infty} |(\xi, \eta_i)|^2$$

as $n \to \infty$. By (5) and the definition of $d$, we have

$$\|\xi - \hat{\xi}\|^2 = d^2 = \|\xi\|^2 - \sum_{i=1}^{\infty} |(\xi, \eta_i)|^2.$$

Hence $\|\xi - \hat{\xi}_n\| \to \|\xi - \hat{\xi}\|$, and since $\hat{\xi}_n \in \overline{\mathcal{L}}$, we have $\hat{\xi}_n \to \hat{\xi}$ in mean square, i.e.,

$$\hat{\xi} = \lim_{n \to \infty} \sum_{i=1}^{n} (\xi, \eta_i) \eta_i.$$

Finally, $\xi - \hat{\xi} \perp \zeta$ for all $\zeta \in \overline{\mathcal{L}}$ follows from $\|\xi - \hat{\xi}\| = d$ and the minimal distance characterization.
