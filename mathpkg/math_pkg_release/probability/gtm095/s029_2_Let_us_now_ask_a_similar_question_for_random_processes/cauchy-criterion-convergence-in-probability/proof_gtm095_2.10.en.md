...
role: proof
locale: en
of_concept: cauchy-criterion-convergence-in-probability
source_book: gtm095
source_chapter: "2"
source_section: "10"
---
...
Conversely, if $(\xi_n)$ is fundamental in probability, by Theorem 5 there are a subsequence $(\xi_{n_k})$ and a random variable $\xi$ such that $\xi_{n_k} \xrightarrow{\text{a.s.}} \xi$. But then ($\text{a.s.} \Rightarrow P$ by Theorem 2)
