...
But $0 \leq (\xi - \xi_n)I_{\{\xi \geq \xi_n\}} \leq \xi$, and by the dominated convergence theorem,

$$E(\xi - \xi_n)I_{\{\xi \geq \xi_n\}} \to 0, \quad n \to \infty.$$

Also $E(\xi_n - \xi) = E\xi_n - E\xi \to 0$ by hypothesis. Hence $E|\xi - \xi_n| \to 0$. $\square$
