...
role: proof
locale: en
of_concept: uniform-convergence-of-product-of-continuous-functions
source_book: gtm011
source_chapter: "5"
source_section: "5.2"
---

Since $\sum g_n(x)$ converges uniformly for $x$ in $X$, there is an integer $n_0$ such that $|g_n(x)| < \frac{1}{2}$ for all $x$ in $X$ and $n > n_0$. This implies that $\text{Re} [1 + g_n(x)] > 0$ and also, according to inequality (5.3), $|\log (1 + g_n(x))| \leq \frac{3}{2} |g_n(x)|$ for all $n > n_0$ and $x$ in $X$. Thus
