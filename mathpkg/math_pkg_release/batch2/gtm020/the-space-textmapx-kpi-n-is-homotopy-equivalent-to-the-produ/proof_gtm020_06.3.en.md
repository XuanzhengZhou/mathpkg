---
locale: en
of_concept: the-space-textmapx-kpi-n-is-homotopy-equivalent-to-the-produ
role: proof
source_book: gtm020
...
For another proof we start with the evaluation map $e(f) = f(*)$ at a base point $* \in X$. This is a
