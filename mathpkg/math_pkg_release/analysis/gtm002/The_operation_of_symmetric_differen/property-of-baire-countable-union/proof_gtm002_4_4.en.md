...
role: proof
locale: en
of_concept: property-of-baire-countable-union
source_book: gtm002
source_chapter: "4"
source_section: "4. The Property of Baire"
---
Let $A_i = G_i \triangle P_i$ ($i = 1, 2, \ldots$) be any sequence of sets having the property of Baire. Put $G = \bigcup G_i$, $P = \bigcup P_i$, and $A = \bigcup A_i$. Then $G$ is open, $P$ is of first category, and
