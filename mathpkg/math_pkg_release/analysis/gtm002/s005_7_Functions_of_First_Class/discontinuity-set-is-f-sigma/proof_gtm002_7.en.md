...
Each set $\{x : \omega(x) \geq 1/n\}$ is the complement of the open set $\{x : \omega(x) < 1/n\}$, hence is closed. Therefore $D$ is a countable union of closed sets, i.e., an $F_\sigma$ set.
