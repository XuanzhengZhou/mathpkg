...
role: proof
locale: en
of_concept: completeness-of-measurable-sets-under-symmetric-difference-metric
source_book: gtm002
source_chapter: "10"
source_section: "10"
---
...
For any $\varepsilon > 0$, choose $i$ large enough so that $1/2^{i-1} < \varepsilon$. Then for all $n \geq n_i$, we have $\varrho(E, E_n) \leq \varrho(E, F_i) + \varrho(F_i, E_n) < \varepsilon + \varepsilon = 2\varepsilon$. Hence $\tilde{E}_n \to \tilde{E}$ in $(\tilde{S}, \varrho)$, proving completeness.
