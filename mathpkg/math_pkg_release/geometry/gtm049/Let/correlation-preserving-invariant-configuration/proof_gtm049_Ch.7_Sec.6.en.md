...
By Proposition 10, there is a module isomorphism $g$ of $V_f$ onto $(V^*)_{f^t}$. We show that the correlation $\mathcal{P}(g)_\circ$ has the required property.
...
This shows that $Mfg \subset (Mg)^\circ = Mg$ and so $Mf \subset M$, i.e., $M$ is $f$-invariant.

Thus the correlation $\mathcal{P}(g)_\circ$ maps the invariant configuration of $\mathcal{P}(f)$ onto itself.
