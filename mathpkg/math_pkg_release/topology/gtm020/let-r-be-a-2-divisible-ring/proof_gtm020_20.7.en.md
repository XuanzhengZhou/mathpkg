---
locale: en
of_concept: let-r-be-a-2-divisible-ring
role: proof
source_book: gtm020
...
The construction of $a$ and $m$ proceeds as in paragraph 1 of the proof of (4.3) and the monomorphic character of $a$ and $m$ as semigroup morphisms as in paragraphs 2 and 3.
