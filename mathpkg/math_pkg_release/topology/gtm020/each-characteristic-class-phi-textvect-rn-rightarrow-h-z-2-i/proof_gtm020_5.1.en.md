...
role: proof
locale: en
of_concept: each-characteristic-class-phi-textvect-rn-rightarrow-h-z-2-i
source_book: gtm020
...
Proof. Let $w_i$ and $\bar{w}_i$ be two sets of Stiefel-Whitney classes, and let $\xi^n$ be a vector bundle with splitting map $f: B_1 \rightarrow B$. Since $w_1$ is uniquely determined for line
