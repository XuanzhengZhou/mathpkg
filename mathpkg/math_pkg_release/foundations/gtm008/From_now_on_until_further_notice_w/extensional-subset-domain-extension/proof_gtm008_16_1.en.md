...
role: proof
locale: en
of_concept: extensional-subset-domain-extension
source_book: gtm008
source_chapter: "16"
...
$$\llbracket u_i = u'_i \rrbracket = \prod_{x \in \mathcal{D}(u_i)} (u_i(x) \Rightarrow \llbracket x \in u'_i \rrbracket) \cdot 1$$
$$\geq \prod_{x \in \mathcal{D}(u_i)} (u_i(x) \Rightarrow u'_i(x))$$
$$= \prod_{x \in \mathcal{D}(u_i)} (u_i(x) \Rightarrow \llbracket x \in u_i \rrbracket) = 1$$
