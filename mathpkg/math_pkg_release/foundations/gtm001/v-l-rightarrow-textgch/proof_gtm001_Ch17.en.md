...
role: proof
locale: en
of_concept: v-l-rightarrow-textgch
source_book: gtm001
source_chapter: "17"
source_section: ""
---
...
Hence $a = D(\hat{x}^{\gamma + 1}(x \in \aleph_\alpha \wedge x \in t'))$, where $\gamma = \max(\aleph_\
